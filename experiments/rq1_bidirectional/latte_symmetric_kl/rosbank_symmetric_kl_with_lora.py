...
EXPERIMENT_BASE_ID = "symmetric_kl_rosbank"
...
def main(use_lora: bool = True) -> None:
    ...
    output_directory = Path(f"results/rosbank_true_bidirectional{output_dir_suffix}")
    ...
    if not COLES_CHECKPOINT_PATH.exists():
        raise FileNotFoundError(
            ...
            f"Run: python experiments/rq1_bidirectional/latte/rosbank_latte.py first"
        )
